...
function systemPrompt(context, input) {
  ...
  return [
    ...
    'نسّق الرد تعليميًا: استخدم ### قبل عنوان رئيس قصير، واستخدم **النص** للكلمات أو الإجابة أو القاعدة المهمة.',
    'اجعل في الرد الطويل عنوانين رئيسين كحد أقصى و1–3 مواضع Bold مهمة فقط. لا تجعل الفقرات العادية Bold ولا تجعل كل جملة عنوانًا.',
