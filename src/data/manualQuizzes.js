...
Edison was a prolific inventor, holding 1,093 US patents, as well as many patents in the United Kingdom, France, and Germany. More significant than the number of Edison's patents, are the impacts of his inventions, because Edison not only invented things, his inventions established major new industries worldwide, notably, electric light and power utilities, sound recording and motion pictures. Edison's inventions contributed to mass communication and, in particular, telecommunications.` },
  ...
  {
    id:'reading-09',order:9,title:'النموذج التاسع',subtitle:'اختر قطعة داخل النموذج ثم ابدأ الاختبار',passages:[
      makeMixedPassage('reading-09','juliet',1,'القطعة الأولى','Joliet','أولاً / جولييت',[
        ['What is the title of the story?','Profile of Joliet',['The Life of a Traveler','A Busy Husband','Joliet’s Organization']],
        ['What does the pronoun “it” refer to?','The way',['The organization','England','Her husband']],
        ['What do you think of her husband?','He was busy.',['He was unemployed.','He was generous.','He was ill.']],
        ['What is NOT mentioned in the story?','She died.',['She was seventeen.','She moved to England.','She founded an organization.']],
        ['Choose the correct order of events.','She married → travelled → met girls → established an organization.',['She travelled → married → established an organization → met girls.','She met girls → married → travelled → established an organization.','She established an organization → married → travelled → met girls.']],
      ]),
      makeMixedPassage('reading-09','shaybah',2,'القطعة الثانية','The Empty Quarter and Shaybah Oil Field','ثانياً / الربع الخالي وحقل شيبة',[
        ['What did Bertram Thomas do when he visited the Shaybah Oil Field?','He visited it and wrote about his visit.',['He managed the field.','He photographed the royal families.','He built the field.']],
        ['Why were the scientists amazed when they visited it?','Birds could live there and find food.',['There was no sand.','The field was larger than Ghawar.','It was below sea level.']],
        ['Where is the Shaybah Oil Field located?','In the middle of the desert.',['Near the coast.','In the city center.','In the mountains.']],
        ['Which is bigger, Shaybah or Ghawar Field?','Ghawar is larger than Shaybah.',['Shaybah is larger than Ghawar.','They are exactly the same size.','Neither field is larger.']],
        ['What is the temperature in the Empty Quarter at night?','Below zero.',['Above 40°C.','Exactly zero.','Mild and warm.']],
      ]),
      makeMixedPassage('reading-09','paris-trip',3,'القطعة الثالثة','A Trip to Paris','ثالثاً / المرأة وزوجها اللذان سافرا إلى باريس',[
        ['Where did they go on the second day?','They went sightseeing and visited the Eiffel Tower.',['They returned to the airport.','They stayed in the hotel all day.','They went to the desert.']],
        ['Why did they travel?','For shopping and sightseeing.',['For food only.','To visit their family.','For work.']],
        ['What is NOT true in the first paragraph?','They stayed near the hotel on the first day.',['They arrived tired.','They slept and woke up late.','They went out to the market.']],
        ['What is NOT true according to the paragraph?','She sat under the hotel waiting all day.',['She went out and wandered.','She bought a sandwich.','They missed breakfast.']],
        ['Choose the correct sentence according to the second paragraph.','She visited the Eiffel Tower.',['She ate breakfast at the hotel.','She returned home.','She went to the airport.']],
        ['What does “head up to” mean?','Move towards.',['Stay behind.','Wait for.','Turn away from.']],
        ['Did they have breakfast at the hotel on the second day?','Yes, they did.',['No, they did not.','Only the wife did.','Only the husband did.']],
        ['What does the pronoun “there” refer to?','The Seine River.',['The hotel.','The Indian restaurant.','The city center.']],
      ]),
      { ...makeMixedPassage('reading-09','tailgating',4,'القطعة الرابعة','Tailgating','رابعاً / القيادة المتقاربة الخطرة',[
        ['What does “tailgating” mean?','Driving too closely behind another vehicle; it is unsafe.',['Driving slowly in a safe lane.','Parking beside another vehicle.','Driving alone at night.']],
        ['What does “escalate” mean?','Increase.',['Decrease.','Stop.','Move sideways.']],
        ['Why are people afraid of tailgating?','Because it can cause accidents and make people feel worried or scared.',['Because it saves fuel.','Because it improves visibility.','Because it prevents road rage.']],
        ['What is the main idea of the second paragraph?','Road rage.',['Passenger comfort.','Buying a new car.','Traffic signs.']],
        ['What does a defensive driver do?','Reduces the likelihood of accidents.',['Causes more accidents.','Drives without a seat belt.','Follows vehicles very closely.']],
      ]), passageText:`Tailgating is when a driver drives behind another vehicle without leaving sufficient distance to stop without causing a collision if the vehicle in front stops suddenly.` },
      makeMixedPassage('reading-09','rainy-day',5,'القطعة الخامسة','A Mother and Daughter in the Rain','خامساً / الأم وابنتها تحت المطر',[
        ['What were the people doing in the mall?','Avoiding the rain.',['Shopping for clothes.','Waiting for a bus.','Watching a film.']],
        ['Why didn’t the mother go out with her daughter at first?','She did not want to get wet.',['She was tired.','She was shopping.','She was afraid of the mall.']],
        ['What did the girl say about her father?','He had a dangerous disease—cancer.',['He was traveling.','He was a doctor.','He had won a prize.']],
        ['Why did people wonder about the girl’s words?','She spoke confidently, and her words surprised them.',['She was whispering.','She was selling something.','She was lost.']],
        ['What did the people do at last?','They went out laughing and remembering happy things.',['They called the police.','They stayed inside silently.','They returned to work.']],
        ['Why were people laughing when the mother ran with her daughter?','They remembered their childhood.',['They were laughing at the rain.','They had heard a joke.','They were celebrating a wedding.']],
        ['What will wash the city?','The falling rain.',['The wind.','The river.','The sunlight.']],
        ['What effect did the event leave on the speaker?','Happy memories.',['Fear of travel.','Anger.','A desire to leave the city.']],
        ['What did the person who followed them do?','He chased after their car quickly.',['He entered the mall.','He repaired their car.','He waited at the hotel.']],
      ]),
      makeMixedPassage('reading-09','restaurants',6,'القطعة السادسة','Fast-Food Restaurants','سادساً / جدول المطاعم (الوجبات السريعة)',[
        ['Which restaurant do most adults go to?','K.F.C.',['McDonald’s','Burger King','Pizza Hut']],
        ['What is the most popular restaurant in the world for all ages?','McDonald’s.',['K.F.C.','Subway','Pizza Hut']],
      ]),
      makeMixedPassage('reading-09','wedding-invitation',7,'القطعة السابعة','Wedding Ceremony Invitation','سابعاً / بطاقة حفلة زفاف',[
        ['Who invited guests to the wedding?','Both families.',['The groom’s family only','The bride’s family only','Michael and Marie']],
      ]),
      makeMixedPassage('reading-09','lost-pen',8,'القطعة الثامنة','Lost Pen Advertisement','ثامناً / إعلان مفقودات (القلم الضائع)',[
        ['What kind of advertisement is it?','A missing-item advertisement.',['A job advertisement.','A wedding advertisement.','A travel advertisement.']],
        ['Why is the pen important to its owner?','It was a gift from his father.',['It is very expensive.','It was bought in New York.','It belongs to his manager.']],
      ]),
      makeMixedPassage('reading-09','road-closed',9,'القطعة التاسعة','Road Closed Sign','تاسعاً / عبارة تحذيرية',[
        ['What do you understand from “Road closed”?','The road cannot be used; passing is not allowed.',['The road is newly built.','Only buses may use the road.','The road is open at night.']],
      ]),
      makeMixedPassage('reading-09','repair-shop',10,'القطعة العاشرة','A Thank-You Message to a Repair-Shop Manager','عاشراً / رسالة شكر لمدير محل إصلاح الأجهزة',[
        ['What was the problem with the man’s device, and why did he visit the company?','It contained an unwanted application that he had not downloaded.',['The screen was broken.','The battery was empty.','He wanted to buy a new phone.']],
        ['What does “device” mean?','Mobile phone.',['Computer desk.','Television.','Car engine.']],
        ['What message did the man send to the shop?','Thanks.',['A complaint.','A delivery address.','A cancellation.']],
        ['What did the staff do for the man?','They downloaded an antivirus application.',['They sold him a car.','They replaced his house.','They deleted his photographs.']],
        ['What does “head” mean in the passage?','Director or manager.',['Customer.','Technician.','Owner’s son.']],
        ['What will the man do?','Recommend the shop and tell other people about it.',['Close the shop.','Work for the shop.','Ask for a refund.']],
        ['What is the relationship between Mohammed and the staff?','He is their manager.',['He is their customer.','He is their neighbor.','He is their teacher.']],
        ['What is Mohammed’s job?','Manager.',['Driver.','Doctor.','Sales assistant.']],
        ['What is TRUE according to the passage?','The shop took the man’s phone for repair.',['The man lost his phone.','The shop refused to help him.','The man bought a tablet.']],
      ]),
      makeMixedPassage('reading-09','tom-roger',11,'القطعة الحادية عشرة','Tom and Roger','الحادي عشر / توم وروجر',[
        ['What did Tom ask Roger?','Can I visit you at the weekend?',['Can you work on Friday?','Did you travel yesterday?','Will you call the shop?']],
      ]),
      makeMixedPassage('reading-09','price-and-time',12,'القطعة الثانية عشرة','Short Information: Price and Class Time','الثاني عشر / معلومات قصيرة',[
        ['How much is it?','It is 7.99 Riyals.',['It is 9 Riyals.','It is 6.99 Riyals.','It is free.']],
        ['What time is the class?','At 9 a.m.',['At 7 a.m.','At noon.','At 9 p.m.']],
      ]),
    ]
  },
  {
    id:'reading-10',order:10,title:'النموذج العاشر',subtitle:'اختر قطعة داخل النموذج ثم ابدأ الاختبار',passages:[
      makeMixedPassage('reading-10','sheba',1,'القطعة الأولى','Sheba and Bilqis','أولاً / مملكة سبأ',[
        ['What is the best title for the passage?','The History of Sheba and Bilqis.',['The Prophet Solomon.','A Modern Kingdom.','The Empty Quarter.']],
      ]),
      makeMixedPassage('reading-10','fire-risk',2,'القطعة الثانية','Fire Risk Sign','ثانياً / صورة تحذيرية (Fire Risk)',[
        ['This sign means not to do what?','Smoke.',['Play.','Study.','Run.']],
      ]),
      makeMixedPassage('reading-10','thank-you-email',3,'القطعة الثالثة','A Thank-You Email','ثالثاً / رسالة شكر من طالب إلى معلمة',[
        ['Who is the message addressed to?',null,['His dad.','Teacher.','Classmate.','The school.']],
      ]),
      makeMixedPassage('reading-10','suez-canal',4,'القطعة الرابعة','The Suez Canal','رابعاً / قناة السويس',[
        ['Compared with the Suez Canal, how was the new building described?','Extremely inexpensive.',['Extremely expensive.','Very small.','Temporarily closed.']],
        ['To whom was the opening of the Suez Canal important?','The Europeans.',['Only local farmers.','American students.','South African miners.']],
        ['What is Port Said?','A man-made harbor.',['A natural lake.','A mountain village.','A railway station.']],
        ['What was the nationality of the project manager?','French.',['British.','Egyptian.','Italian.']],
        ['The Suez Canal connects which two things?','Two seas.',['Two rivers.','Two channels.','Two deserts.']],
      ]),
      makeMixedPassage('reading-10','postage-history',5,'القطعة الخامسة','Mailing History','خامساً / تاريخ الطابع البريدي',[
        ['What is the title of the passage?','Mailing History.',['Start Mail.','Mail Story.','Postage Stamp.']],
        ['How did messages arrive in the old days, or why did some letters not arrive?','Receivers had to pay to receive a message.',['Letters were always free.','There were no post offices.','Only kings could send letters.']],
        ['Which country uses the most stamps?','Britain.',['France.','India.','Canada.']],
        ['Why did sending messages cost money?','Because postage was related to the weight of the message.',['Because letters were delivered by train only.','Because stamps were made of gold.','Because messages were read aloud.']],
        ['What was the first country to apply a postage stamp?','Britain (the UK).',['The United States.','France.','China.']],
        ['Did people accept the new system?','Yes; it was applied in most countries.',['No; it was immediately abandoned.','Only soldiers accepted it.','Only Britain rejected it.']],
        ['Why did some people not receive their mail?','They were required to pay money.',['The mail was delivered too quickly.','They lived near a harbor.','The letters were too short.']],
        ['What does “adapted” mean?','Accepted.',['Rejected.','Delayed.','Written.']],
        ['What did Hill suggest?','The price should be proportionate to the weight, and senders should buy a stamp.',['All letters should be free.','Only receivers should write letters.','Post offices should close.']],
        ['In 1800, what was the hardship of sending messages?','Delivery.',['Printing.','Translation.','Decoration.']],
        ['Before 1384, how were messages dealt with?','By the number of pages.',['By color.','By the sender’s age.','By the weather.']],
      ]),
      { ...makeMixedPassage('reading-10','iceland-weather',6,'القطعة السادسة','Weather in Iceland','سادساً / جو أيسلندا',[
        ['What is the best title for the passage?','Difficult times teach you new things.',['The Worst Vacation of My Life','I Advise You Not to Travel to Iceland','A Guide to Warm Beaches']],
        ['What did you understand about the weather?','It was rainy for more than a week.',['It was hot all week.','It was snowy for one hour.','It was dry and warm.']],
        ['What does “it” refer to?','The sun.',['The tour guide.','The beach.','The island.']],
        ['What does “dabble” mean in context?','Wet.',['Dry.','Travel.','Rest.']],
        ['What does “exhausted” mean?','Tired.',['Wet.','Refunded.','Not happy.']],
        ['Why was he happy during the last days?','Because the weather got better.',['Because the guide left.','Because the rain increased.','Because he returned to work.']],
        ['Why did the writer talk about the weather?','To inform people who want to travel to a particular city.',['To sell umbrellas.','To describe a restaurant.','To explain a historical war.']],
        ['What does the man do every summer?','He relaxes.',['He reads books only.','He works in a factory.','He studies weather maps.']],
        ['What did the man and his companions learn?','How to keep their belongings dry.',['How to build a boat.','How to catch fish.','How to climb a mountain.']],
        ['What is meant by paragraph 2 about the city?','He did not see the sun for nine days.',['The city had no airport.','The city was crowded.','The city was very hot.']],
        ['Which statement is correct?','The man was not ready for the weather.',['He knew nothing about Iceland.','He expected hot weather.','He had never traveled before.']],
        ['Why was he happy in the last days?','Because the weather had improved.',['Because the tour was cancelled.','Because the beach was closed.','Because the rain became heavier.']],
        ['Why did the writer talk about the weather?','Travelers want to understand the weather of a specific city.',['To compare two restaurants.','To explain a medical treatment.','To advertise a car.']],
      ]), passageText:`One always travels to a place by the sea, but last year he decided to travel to an island. Knowing that it was cold and rainy, he found the weather colder and rainier than expected. He did not see the sun and the rain continued for nine continuous days. A tour guide taught them how to keep their things dry and safe. During the last four days, the weather became sunny and pleasant, and they enjoyed the beach.` },
      makeMixedPassage('reading-10','stress-earthquakes',7,'القطعة السابعة','Stress and Earthquakes','سابعاً / التوتر وتأثيره على الإنسان والزلازل',[
        ['The word “overloaded” in paragraph 1 is closest in meaning to:','Feeling under pressure.',['Feeling not listened to.','Feeling not supported.','Feeling overweight.']],
        ["What does the expression 'fight or flight response' mean?", "The ways a person’s body reacts to a dangerous situation.",['Staying in danger and facing it.','Getting away from danger very quickly.','The ways danger changes with stress.']],
        ['According to paragraph 3, what is the best advice during an earthquake?','Try to get out of the building as quickly as possible.',['Save someone else before yourself.','Wait inside until the earthquake ends.','Make sure no heavy weight has fallen on you.']],
        ['The word “it” in paragraph 4 refers to what?',null,['Body','Cortisol','Adrenaline','Noradrenaline']],
        ["According to paragraph 5, what is TRUE about a 'fight or flight' situation?",'The digestive and immune systems are considered non-essential.',['All body functions are essential.','All body functions are non-essential.','The digestive and immune systems are essential.']],
        ['Why does the author use the pronoun “we” throughout the passage?','Because he believes many others share the feeling.',['Because he describes someone else’s experience.','Because the experience is unique to him.','Because he distances himself from the experience.']],
      ]),
      { ...makeMixedPassage('reading-10','globalization',8,'القطعة الثامنة','Globalization','ثامناً / العولمة Globalization',[
        ['What does “antique” mean?','Very old.',['Tired.','New.','Metallic.']],
        ['Why is Indian food mentioned?','As an example of globalization.',['As an example of a local-only tradition.','To describe a restaurant menu.','To explain a medical diet.']],
        ['If the text continued, what would it discuss?','The importance of globalization today.',['The history of one restaurant.','How to grow rice.','The weather in India.']],
        ['What does “it” refer to in the globalization passage?',null,['Indian food','The Old World','The chili pepper','The trading process']],
        ['Where did peppers and spicy food originate?','North and South America.',['Europe and Asia.','Africa and Australia.','India and China.']],
        ['Where is pepper grown or obtained from according to the notes?','North and South America.',['Only India.','Only Europe.','The Arabian Peninsula only.']],
        ['What does “they” refer to in paragraph 3?', 'The sailors.',['The restaurants.','The peppers.','The governments.']],
        ['What does “herbs” mean?','Plants.',['Animals.','Spices only.','Tools.']],
        ['Choose the passage’s title.','Globalization Is Not New.',['The History of Indian Restaurants.','Modern Government.','The World’s Oldest Plant.']],
        ['Who invented globalization?','No one; it has existed since people began to trade.',['A Chinese emperor.','A modern government.','A single sailor.']],
        ['What does “great power” refer to?',null,['Global government','Global trade','National wealth','Education']],
        ['What limits poverty rates?','Globalization.',['Education.','Weather.','Tourism.']],
        ['What is the origin of the artifacts and antiques mentioned?','China and the Arabian Peninsula.',['Norway and China.','North and South America.','Arabia and North America.']],
      ]), passageText:`Many people think globalization is a new phenomenon. In fact, this process has been happening for thousands of years. For example, some very old Chinese artifacts have been found in North and South America, and antique Arabian money has been found as far north as Norway.\n\nWhat is even more remarkable is how quickly plants from the New World became staples in the Old World. Hungarian cooking is famous for red peppers, and the Irish are famous for eating potatoes. Indian food is an even better example. In many “traditional” Indian dishes, you may find potatoes, tomatoes, squash, corn, sweet peppers, peanuts, cashew nuts, guavas, or papaya.\n\nWe think of all this food as traditional Indian food. Yet sailors brought these plants to India from America on ships after 1500. They took a long time to spread and become popular. The chili pepper is now part of diets from South Africa to China, but it originated in the Americas. Globalization is really nothing new; it has happened since people began to trade.` },
      makeMixedPassage('reading-10','ice-cream',9,'القطعة التاسعة','Ice-Cream Car and History','تاسعاً / سيارة الآيس كريم',[
        ['Who is the best car driver?','The driver of an ice-cream car.',['A taxi driver.','A bus driver.','A racing driver.']],
        ['From paragraph 1, what do you understand?','He is a good driver.',['He sells books.','He repairs cars.','He avoids driving.']],
        ['What is the best title for the passage?','Ice-Cream History.',['A Trip to Iceland.','The History of Cars.','Fast-Food Restaurants.']],
        ["What is the car’s name?",'Ice-cream car.',['Family car.','Tour bus.','Delivery van.']],
        ['What is the type of car?','Ice-cream car.',['Sports car.','Police car.','Train.']],
        ['What is true about the ice-cream-car driver?','He is happy and does not complain.',['He is angry and tired.','He never drives.','He dislikes ice cream.']],
        ['What does “expedition” mean?','Journey.',['Accident.','Meal.','Warning.']],
        ['The frozen dessert includes 60% of what?','Ice cream.',['Fruit.','Sugar only.','Milk only.']],
        ['Who discovered ice cream?','Smithson.',['Newton.','Edison.','Hill.']],
        ['Who added fruits to ice cream?','Asia.',['Europe.','Africa.','South America.']],
        ['What happened to ice cream during the World War?','There was not enough sugar.',['There was too much sugar.','It became free.','It disappeared from Asia.']],
        ["What does the word 'low' mean in the traffic-related note?",null,['No traffic fines','Very high','Very fast','Very expensive']],
      ]),
      { ...makeMixedPassage('reading-10','lemurs',10,'القطعة العاشرة','Lemurs of Madagascar','عاشراً / الليمور في مدغشقر',[
        ['The word “its” refers to what?', 'The ring-tailed lemur.',['Species','Bang lumber','Madagascar']],
      ]), passageText:`Lemurs are mammals divided into eight families and consisting of fifteen genera and around one hundred existing species. They are native only to the island of Madagascar. Most existing lemurs are small, have a pointed snout, large eyes, and a long tail. They chiefly live in trees and are active at night (nocturnal).` },
      makeMixedPassage('reading-10','gas-production',11,'القطعة الحادية عشرة','Reducing Gas Production','الحادي عشر / تقليل إنتاج الغاز من قبل الحكومة',[
        ['Why did the government reduce production?','Because it wanted to increase the price of gas.',['Because gas was free.','Because people stopped driving.','Because production was too low.']],
        ['What was the speaker’s reaction?','He thought it was a good sign.',['It was unpleasant.','He did not know about the change.','He thought it was dangerous.']],
        ['Why did people use less gasoline in 2008?','Gasoline became very expensive.',['Gasoline became free.','Cars stopped working.','People moved to another country.']],
      ]),
    ]
  },
];
